# PES1UG24AM046-pes-vcs

**Ansh Vardhan Singh | PES1UG24AM046 | anshvsingh2020@gmail.com**
...
```bash
git clone https://github.com/anshvsingh/PES1UG24AM046-pes-vcs
cd PES1UG24AM046-pes-vcs
```

### Set Your Author

```bash
export PES_AUTHOR="Ansh Vardhan Singh <anshvsingh2020@gmail.com>"
```

To make it permanent:

```bash
echo 'export PES_AUTHOR="Ansh Vardhan Singh <anshvsingh2020@gmail.com>"' >> ~/.bashrc
source ~/.bashrc
```
...
author Ansh Vardhan Singh <anshvsingh2020@gmail.com> 1776751432
committer Ansh Vardhan Singh <anshvsingh2020@gmail.com> 1776751432
...
**4A — pes log output:**
Shows full commit chain with hashes, author `Ansh Vardhan Singh <anshvsingh2020@gmail.com>`, timestamps and messages.
